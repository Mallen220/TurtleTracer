...
Turtle Tracer ("the Application") is an open-source application available as both a desktop version and a web-based browser version. It is designed to visualize and plan autonomous routines for FIRST Tech Challenge. We respect your privacy and are committed to protecting it.

This Privacy Policy explains what information the Application collects, how it is used, and your rights regarding your data. By using Turtle Tracer, you agree to the collection and use of information in accordance with this policy.

## Data Collection and Usage

While Turtle Tracer is designed to process your project data locally, we use third-party services to help us improve the application and provide a better user experience.

### Local Project Data

Any data you create, import, or save within the Application (such as path files, robot configurations, or telemetry logs) remains on your local machine or within your browser's local storage. We do not have access to your private project files.
...
The desktop version of the Application uses GitHub Releases to check for and download software updates. When the Application checks for an update, it makes a standard web request to GitHub's servers.

...
/**
 * Scales path data by a given factor in X and Y relative to a pivot point.
 * This is incredibly useful for resizing complex autonomous routines or macros
 * to fit tighter spaces while mathematically preserving the relative shape
 * and smoothness of the splines, which is nearly impossible to do manually.
 */

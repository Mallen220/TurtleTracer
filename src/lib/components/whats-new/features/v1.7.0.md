...
Connect with other users, get help, share your projects and ideas, and be part of the development of Turtle Tracer via the project's official channels (GitHub and documentation).
...
Extended with custom functionality and share your creations.
...
Make the program work the way you want.

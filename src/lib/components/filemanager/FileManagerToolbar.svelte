...
<div
  class="flex items-center gap-2 p-2 border-b border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 shrink-0 z-10"
>
  <!-- Search -->
  ...
  <!-- View Toggle -->
  <!-- Currently omitted as grid view might be complex to implement nicely in a sidebar, but kept in props for future -->

...
<script lang="ts">
  ...
  $: paletteCommands = [
    ...
    // New Commands
    {
      ...
      label: "Zoom to Fit",
      category: "View",
      action: (actions as any).zoomReset,
    },
    {
      id: "show-debug",
      label: "Show/Hide Debug Sequence",
      category: "View",
      action: (actions as any).toggleDebugSequence,
    },
    {
      id: "toggle-bounds",
      label: "Toggle Field Boundaries",
      category: "View",
      action: (actions as any).toggleFieldBoundaries,
    },
    {
      id: "toggle-drag",
      label: "Toggle Drag Restriction",
      category: "View",
      action: (actions as any).toggleDragRestriction,
    },
    {
      id: "pan-start",
      label: "Pan to Start Point",
      category: "View",
      action: (actions as any).panToStart,
    },
    {
      id: "pan-end",
      label: "Pan to End Point",
      category: "View",
      action: (actions as any).panToEnd,
    },
    {
      id: "select-last",
      label: "Select Last Point",
      category: "Editing",
      action: (actions as any).selectLast,
    },
    {
      id: "reset-start",
      label: "Reset Start Point",
      category: "Editing",
      action: (actions as any).resetStartPoint,
    },
    {
      id: "snap-select",
      label: "Snap Selection to Grid",
      category: "Editing",
      action: (actions as any).snapSelection,
    },
    {
      id: "copy-json",
      label: "Copy Path JSON to Clipboard",
      category: "Export",
      action: (actions as any).copyPathJson,
    },
    {
      id: "theme-light",
      label: "Set Theme: Light",
      category: "Settings",
      action: () => (actions as any).setTheme("light"),
    },
    {
      id: "theme-dark",
      label: "Set Theme: Dark",
      category: "Settings",
      action: () => (actions as any).setTheme("dark"),
    },
    {
      id: "auto-save-never",
      label: "Autosave: Never",
      category: "Settings",
      action: () => (actions as any).setAutosave("never"),
    },
    {
      id: "auto-save-1m",
      label: "Autosave: 1 Minute",
      category: "Settings",
      action: () => (actions as any).setAutosave("time", 1),
    },
    {
      id: "auto-save-5m",
      label: "Autosave: 5 Minutes",
      category: "Settings",
      action: () => (actions as any).setAutosave("time", 5),
    },
    {
      id: "auto-save-change",
      label: "Autosave: On Change",
      category: "Settings",
      action: () => (actions as any).setAutosave("change"),
    },
    {
      id: "auto-save-close",
      label: "Autosave: On Close",
      category: "Settings",
      action: () => (actions as any).setAutosave("close"),
    },
    {
      id: "docs",
      label: "Open Documentation",
      category: "Help",
      action: (actions as any).openDocs,
    },
    {
      id: "issues",
      label: "Report Issue",
      category: "Help",
      action: (actions as any).reportIssue,
    },
  ];

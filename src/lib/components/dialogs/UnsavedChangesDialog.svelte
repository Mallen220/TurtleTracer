...
{#if show}
  ...
  >
    <div
      class="bg-white dark:bg-neutral-800 rounded-lg shadow-sm w-full max-w-md p-6 border border-neutral-200 dark:border-neutral-700 animate-in fade-in zoom-in-95 duration-200"
    >

  ...
  function copyDebugData() {
    ...
    navigator.clipboard
      ...
      .catch((err) => {
        ...
        notification.set({
          message: "Failed to copy debug data.",
          type: "error",
        });
      });
  }
...
<div
  class="p-3 mt-2 mb-2 text-xs text-neutral-600 dark:text-neutral-400 bg-neutral-100 dark:bg-neutral-800/50 rounded-lg border border-neutral-200 dark:border-neutral-700 shadow-sm"
>
  <div
  ...
  <div class="space-y-2">
    ...
    <details class="mt-3 group">
      <summary
        class="cursor-pointer font-medium text-blue-600 dark:text-blue-400 hover:underline select-none"
        >View App State Snapshot</summary
      >

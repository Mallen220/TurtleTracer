<script lang="ts">
  ...
  async function duplicateFile() {
    ...
    try {
      ...
      // Find a unique name
      while (await electronAPI.fileExists(path.join(currentDirectory, newFileName))) {
...
>
  ...
  >
    <div class="flex flex-col h-full">
      ...
      {#if selectedFile}
        <div class="flex-shrink-0 p-4 border-t border-neutral-200 dark:border-neutral-700 space-y-2">

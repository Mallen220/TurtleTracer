...
2024-03-01 - [Visual Flow Indicators] Learning: Pathing applications often suffer from visual ambiguity for static paths (direction, timing, etc) meaning that arrows placed contextually on paths can improve usability dramatically. Action: Remember to evaluate similar implicit UX enhancements for editors and simulators.

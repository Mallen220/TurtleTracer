...
get_download_urls() {
    ...
    if [ -n "$SELECTED_VERSION" ]; then
        api_url="https://api.github.com/repos/Mallen220/PedroPathingPlus/releases/tags/v${SELECTED_VERSION}"
    else
        api_url="https://api.github.com/repos/Mallen220/PedroPathingPlus/releases/latest"
    fi
...
get_latest_version() {
    curl -s "https://api.github.com/repos/Mallen220/PedroPathingPlus/releases/latest" | \
    grep -o '"tag_name": "[^"]*"' | \
...
get_prerelease_version() {
    curl -s "https://api.github.com/repos/Mallen220/PedroPathingPlus/releases" | \
...
install_icon() {
    ...
    ICON_URL="https://raw.githubusercontent.com/Mallen220/PedroPathingPlus/main/build/icon.png"
...
case "$CHOICE" in
    ...
    3)
        ...
        echo ""
        echo "   https://github.com/Mallen220/PedroPathingPlus/releases/latest"
        echo ""
        ;;
    *)
